...
/* Database Related Settings */
    ...
    saved_virtualItems[] = { "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "SkeletonKey", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit" }; //Array of virtual items that can be saved on your player.
...
/* System Settings */
    ...
    revive_fee = 12500; //Revive fee that players have to pay and medics only EMS(independent) are rewarded with this amount.
    hospital_heal_fee = 750; //Fee to heal at a hospital NPC
    ...
    vehicle_purchase_multiplier_MEDIC = .05; //Medic Vehicle Buy Price = Config_Vehicle price * multiplier
    vehicle_purchase_multiplier_OPFOR = -1; // -- NOT IN USE -- Simply left in for east support.

    /* Vehicle Rental Prices */
    vehicle_rental_multiplier_CIVILIAN = 0; //Civilian Vehicle Rental Price = Config_Vehicle price * multiplier
    ...
    crimes[] = {
        {"STR_Crime_187V","60000","187V"}, //Vehicular Manslaughter
        {"STR_Crime_187","60000","187"}, //Manslaughter
        {"STR_Crime_901","80000","901"}, //Escaping Jail
        {"STR_Crime_215","25000","215"}, //Attempted Auto Theft
        {"STR_Crime_213","1000","213"}, //Use of illegal explosives
        {"STR_Crime_211","70000","211"}, //Robbery
        {"STR_Crime_207","70000","207"}, //Kidnapping
        {"STR_Crime_207A","35000","207A"}, //Attempted Kidnapping
        {"STR_Crime_390","5000","390"}, //Public Intoxication
        {"STR_Crime_487","10000","487"}, //Grand Theft
        {"STR_Crime_488","3500","488"}, //Petty Theft
        {"STR_Crime_480","35000","480"}, //Hit and run
        {"STR_Crime_481","25000","481"}, //Drug Possession
        {"STR_Crime_482","7500","482"}, //Intent to distribute
        {"STR_Crime_483","30000","483"}, //Drug Trafficking
        {"STR_Crime_459","60000","459"}, //Burglary
        {"STR_Crime_666","1500","666"}, //Tax Evasion
        {"STR_Crime_667","100000","667"}, //Terrorism
        {"STR_Crime_668","1500","668"}, //Unlicensed Hunting
        {"STR_Crime_1","5000","1"}, //Driving without license
        {"STR_Crime_2","5000","2"}, //Driving in the wrong way of the street
        {"STR_Crime_3","3500","3"}, //Not respecting the signalizations
        {"STR_Crime_4","7500","4"}, //Speeding
        {"STR_Crime_5","1000","5"}, //No headlight in the night
        {"STR_Crime_6","3500","6"}, //Driving kart without helmet
        {"STR_Crime_7","150","7"}, //Badly parked vehicle
        {"STR_Crime_8","50000","8"}, //Rebel vehicle (Not armed)
        {"STR_Crime_9","15000","9"}, //Grand Theft (Civilian Vehicle)
        {"STR_Crime_10","50000","10"}, //Grand Theft (Military Vehicle)
        {"STR_Crime_11","50000","11"}, //Armored Vehicle
        {"STR_Crime_12","10000","12"}, //Flying over the city without authorization
        {"STR_Crime_13","10000","13"}, //Closing the street without authorization
        {"STR_Crime_14","3000","14"}, //Open carry in city (Legal Weapon)
        {"STR_Crime_15","30000","15"}, //Rebel weapon
        {"STR_Crime_16","10000","16"}, //Illegal clothing Seizure
        {"STR_Crime_17","10000","17"}, //Hiding face (Mask)
        {"STR_Crime_18","3000","18"}, //Refuses to cooperate
        {"STR_Crime_19","25000","19"}, //Hit and run
        {"STR_Crime_20","4500","20"}, //Insulting a civilian
        {"STR_Crime_21","500","21"}, //Insulting a soldier
        {"STR_Crime_22","30000","22"}, //Drug dealing
        {"STR_Crime_23","120000","23"}, //Federal Reserve breaking
        {"STR_Crime_24","80000","24"}, //Killing of a civilian
        {"STR_Crime_25","20000","25"} //Killing of a soldier
    };
};
