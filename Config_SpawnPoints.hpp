...
class CfgSpawnPoints {
    class Civilian {
		...
		class Donator {
            displayName = "Donator HQ";
            spawnMarker = "donator_spawn";
            icon = "\a3\ui_f\data\map\MapControl\watertower_ca.paa";
            licenses[] = { { "Donator", true } };
            level[] = { "", "", -1 };
        };
        ...
        class RebelCheckpoint {
            displayName = "Rebel Checkpoint";
            spawnMarker = "reb_spawn_checkpoint";
            icon = "\a3\ui_f\data\map\MapControl\watertower_ca.paa";
            licenses[] = { { "rebel", true } };
            level[] = { "", "", -1 };
        };
    ...
    class Cop {
        ...
        class Pyrgos {
            displayName = "Police Training Ground";
        ...
        class HW {
            displayName = "North Kavala Checkpoint";
