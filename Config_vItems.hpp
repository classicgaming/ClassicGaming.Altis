...
class VirtualShops {
    ...
    class med_market {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon", "SkeletonKey", "fuelFull", "marijuana", "peach", "lollipop", "lockpick", "defibrillator" };
    };
    ...
    class rebel {
        ...
        license = "rebel";
        level[] = { "", "", -1, "" };
        items[] = { "waterBottle", "rabbit", "apple", "ziptie", "redgull", "tbacon", "lockpick", "pickaxe", "fuelFull", "peach", "boltcutter", "blastingcharge" };
    };
    ...
    class drugdealer {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "cocaine_processed", "heroin_processed", "marijuana", "methp", "LSDp" };
    };
    ...
    class cop {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "donuts", "coffee", "SkeletonKey", "spikeStrip", "waterBottle", "rabbit", "apple", "redgull", "lockpick", "fuelFull", "defusekit" };
    };
};
...
class VirtualItems {
    ...
    class yeastu {
        ...
        edible = -1;
        icon = "";
        processedItem = "yeastp";
    };

    class yeastp {
        variable = "yeastp";
        displayName = "STR_Item_yeastp";
        weight = 4;
        buyPrice = 7500;
        sellPrice = 7500;
        illegal = true;
	...
	class lollipop {
        variable = "lollipop";
        displayName = "STR_Item_lollipop";
        weight = 1;
        buyPrice = 50;
        sellPrice = 45;
        illegal = false;
        edible = 5;
        icon = "icons\lollipop.paa";
    };
